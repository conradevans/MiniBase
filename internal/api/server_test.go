...
func TestDatabaseDetail(t *testing.T) {
	...
	assertExactKeys(t, fields, "id", "displayName", "internalName", "status", "guestVisible", "createdAt", "updatedAt", "attachments")
	assertSafeResponse(t, response.Body.String())
}
...
func TestCreateDatabase(t *testing.T) {
	...
	assertExactKeys(t, fields, "id", "displayName", "internalName", "status", "guestVisible", "createdAt", "updatedAt")
	assertSafeResponse(t, response.Body.String())
